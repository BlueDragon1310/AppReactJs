...
import ModificationNote from './pages/ModificationNote'
import Statistiques from './pages/Statistiques'
import Parametres from './pages/Parametres'
import CreationCategorie from './pages/CreationCategorie'
import ModificationCategorie from './pages/ModificationCategorie'
import CreationCarnet from './components/CreationCarnet'
import PageCarnetNote from './components/PageCarnetNote'
